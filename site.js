  ...
  const translations = {
    en: {
      ...
      fullRelease: {
        ...
        intro: "Home Glance v0.2.1 is a focused reliability update for calendar refresh and widget text animation.",
        whatsNew: "What's new",
        item1: "Calendar changes can now refresh the widget automatically instead of waiting for the regular 30-minute widget update window",
        item2: "Added Android Calendar provider change monitoring using a content-triggered background job",
        item3: "Calendar event and reminder changes are debounced briefly before refresh so related provider writes can settle",
        item4: "Fixed clipped standard-mode widget text showing an unwanted ellipsis",
        item5: "Fixed a first-cycle long-text scrolling glitch that could briefly show two calendar text layers after dismissing a smart weather insight",
        item6: "Preserved the existing 30-minute system widget refresh as a fallback",
        testingFocus: "Testing focus",
        attention: "Please pay particular attention to:",
        test1: "adding a new calendar event while the widget is visible",
        test2: "editing an existing event",
        test3: "deleting an event",
        test4: "changing an event reminder",
        test5: "dismissing a smart weather insight while calendar scrolling is enabled",
        test6: "long text in Standard weather mode",
    ...
    pl: {
      ...
      fullRelease: {
        ...
        intro: "Home Glance v0.2.1 to aktualizacja skupiona na niezawodności odświeżania kalendarza i animacji tekstu widżetu.",
        whatsNew: "Co nowego",
        item1: "Zmiany w kalendarzu mogą teraz automatycznie odświeżyć widżet bez czekania na regularne, 30-minutowe okno aktualizacji widżetu",
        item2: "Dodano monitorowanie zmian dostawcy Kalendarza Androida za pomocą zadania w tle uruchamianego zmianą danych",
        item3: "Zmiany wydarzeń i przypomnień są krótko opóźniane przed odświeżeniem, aby powiązane zapisy dostawcy danych mogły się zakończyć",
        item4: "Naprawiono ucinanie tekstu widżetu w standardowym trybie pogody i wyświetlanie niechcianego wielokropka",
        item5: "Naprawiono błąd pierwszego cyklu przewijania długiego tekstu, który po ukryciu inteligentnej wskazówki pogodowej mógł chwilowo pokazać dwie warstwy tekstu kalendarza",
        item6: "Zachowano istniejące systemowe odświeżanie widżetu co 30 minut jako mechanizm awaryjny",
        testingFocus: "Na czym skupić testy",
        attention: "Prosimy zwrócić szczególną uwagę na:",
        test1: "dodawanie nowego wydarzenia kalendarza, gdy widżet jest widoczny",
        test2: "edycję istniejącego wydarzenia",
        test3: "usuwanie wydarzenia",
        test4: "zmianę przypomnienia wydarzenia",
        test5: "ukrywanie inteligentnej wskazówki pogodowej przy włączonym przewijaniu kalendarza",
        test6: "długi tekst w standardowym trybie pogody",
